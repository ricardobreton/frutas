...
@section('content_header')
    <h1>Crear Seccion de la alcaldia {{$alcaldia->nombre}}</h1>
@stop
@php
$configEditor = [
    "height" => "300px",
...
<div class="card text-left">
  <div class="card-body">
    {!! Form::open(['route'=> 'admin.alcaldia.secciones.store', 'autocomplete' => 'off', 'files' => true]) !!}
    {!! Form::hidden('alcaldia_id', $alcaldia->id) !!}
